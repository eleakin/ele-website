...
const benchmarks = [
  { metric: "$67/mo", label: "what the founder paid for a new-homeowner list in his own practice" },
  ...
  return (
    <FadeIn>
      ...
      <p className="mt-4 text-xs text-ink-muted">
        The list figures are the founder&rsquo;s own documented experience in his
