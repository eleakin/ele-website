      ...
      <Section className="border-b border-border bg-surface">
        <div className="grid gap-10 lg:grid-cols-[1.2fr_1fr] lg:items-end">
          <SectionHeading
            ...
            description="Most lead-gen vendors have never sat in the provider's chair. ELE Lead Generation is founded by a chiropractor who used a new-homeowner list to grow his own practice — and who now brings that experience, plus years of data-analytics work, to practices across Nevada."
          />
