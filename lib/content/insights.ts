...
export const insights: Insight[] = [
  ...
  },
  {
    ...
    body: [
      { type: "p", children: "This is a first-person story from my own practice, not a client result — but it is the reason ELE Lead Generation exists. As a practicing chiropractor, I subscribed to an Equifax-sourced new-homeowner list for $67 a month and mailed a simple welcome offer to the new arrivals in my area." },
